...
namespace Theft.Service.Services
{
    public class BikeTheftService : IBikeTheftService
    {
        ...
        public async Task<BikeTheftCountResponse> SearchCountAsync(BikeTheftQueryParams queryParams, CancellationToken cancellationToken)
        {
            ...
            var client = httpClientFactory.CreateClient(BIKE_CLIENT);
            ...
            return await retryPolicy.ExecuteAsync(async () =>
            {
                ...
                string zeroCountMessage = "Please check if the city or geocoordinate are correct, or increase the distance.";

                return new BikeTheftCountResponse(count, count > 0 ? string.Empty : zeroCountMessage, (int)result.StatusCode);
            });
        }
